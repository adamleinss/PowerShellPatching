...
Write-host "Sending out e-mail..."
 ...
 Send-MailMessage -From 'vm-acme-01@milwaukee.k12.wi.us' -To 'patches@milwaukee.k12.wi.us' -Subject 'Server Pilot Patching' -Body "The following servers will be
...
$serverplus4br += "$_ <br>"
 ...
 Send-MailMessage -From 'vm-acme-01@milwaukee.k12.wi.us' -To 'patches@milwaukee.k12.wi.us' -Subject 'Server Weekend Patching +4 days after Patch Tuesday' -Body "The following servers will be
...
$serverplus11br += "$_ <br>"
 ...
 Send-MailMessage -From 'vm-acme-01@milwaukee.k12.wi.us' -To 'patches@milwaukee.k12.wi.us' -Subject 'Server Weekend Patching +11 days after Patch Tuesday' -Body "The following servers will be
...
Send-MailMessage -From 'vm-acme-01@milwaukee.k12.wi.us' -To 'patches@milwaukee.k12.wi.us' -Subject 'Server Weekend Patching +18 days after Patch Tuesday' -Body "The following servers will be
