...
Send-MailMessage -From 'patchreport@milwaukee.k12.wi.us' -To 'leinssam@milwaukee.k12.wi.us' -Subject 'Patch Compliance Report' -Body "
$patchreport" -SmtpServer '10.8.64.101'
