# Shamelessly plucked from https://sqljana.wordpress.com/2017/08/31/powershell-get-security-updates-list-from-microsoft-by-monthproductkbcve-with-api/
# Credited Jana on my blog https://leinss.com/blog as well
...
$rslt | out-file D:\patching\patches.txt